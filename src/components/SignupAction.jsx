...
function actionSignup(prevState, formData) {
  ...
  if (!isNotEmpty(password) || !hasMinLength(password, 6)) {
    errors.push('You must a provide a password with a least six characters.');
  }
...
export default function Signup() {
  const [formState, formAction] = useActionState(actionSignup, {
    errors: null,
  });
